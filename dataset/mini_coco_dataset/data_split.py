...
coco = COCO('/annotations/instances_train2017.json',
            origin_img_dir='/media/su/sdisk/mindspore/ssd/coco_dataset/train2017')               # 完整的coco数据集的图片和标注的路径
coco.build('./mini_train2017', './mini_instances_train2017.json', 50)  # 保存图片路径


coco = COCO('/media/su/sdisk/mindspore/ssd/coco_dataset//annotations/instances_val2017.json',
            origin_img_dir='/media/su/sdisk/mindspore/ssd/coco_dataset/val2017')                 # 完整的coco数据集的图片和标注的路径
coco.build('./mini_val2017', './mini_instances_val2017.json', 10)       # 保存图片路径